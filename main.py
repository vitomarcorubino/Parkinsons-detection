...
audio_dir = "dataset/elderlyHealthyControl"  # The directory where the audio files are stored
...
for wav_file in wav_files:
    ...
    if not audioFileFormat.is_mono_pcm(wf):
        ...
        output_folder_converted = "dataset/elderlyHealthyControl/mono_pcm"
    ...
    if len(data) > 0:
        if rec.AcceptWaveform(data):
            ...
            output_folder_trimmed = "dataset/elderlyHealthyControl/trimmed"

...
df_train = pd.read_csv(r"features/splitted/train_features.csv")
df_validation = pd.read_csv(r"features/splitted/validation_features.csv")
df_test = pd.read_csv(r"features/splitted/test_features.csv")
...
df = pd.read_csv("features/shuffledVowels/shuffledVowels_features.csv")
#print(df)
